...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Basic validation
    if (empty($customer_name) || empty($customer_email) || empty($subject) || empty($message_text)) {
        ...
        try {
            ...
            $sql = "INSERT INTO enquiries (customer_name, customer_email, subject, message) VALUES (:customer_name, :customer_email, :subject, :message_text)";
            ...
            // Execute the query
            if ($stmt->execute()) {
                $response_message = "Enquiry sent successfully! Thank you, " . htmlspecialchars($customer_name) . ". We will get back to you soon.";
            } else {
